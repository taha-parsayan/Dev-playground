...
def copy_data(excel_file, source_root="ADNI", source_dir="../", destination_root="Data", categories=["AD", "MCI", "NC"]):
    ...
    for category in categories:
        if category in xls.sheet_names:
            ...
            for subject_id in test_ids:
                src_file = os.path.join(source_dir, category, source_root, subject_id, "std_T1.nii")
